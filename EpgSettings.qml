                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    text: "Adjust timeline zoom for readability"
                                    font.pixelSize: 13
                                    color: "#CCCCCC"
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                text: "Display program genres and icons in the EPG for better readability"
                                font.pixelSize: 13
                                color: "#CCCCCC"
                                wrapMode: Text.WordWrap
                                Layout.fillWidth: true
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                text: "UI-only, does not alter device clock"
                                font.pixelSize: 13
                                color: "#CCCCCC"
                                wrapMode: Text.WordWrap
                                Layout.fillWidth: true
