...
#include "../../../../../Documents/QT/IPTV-APP/AppState.h"
...
template <> constexpr inline auto AppState::qt_create_metaobjectdata<qt_meta_tag_ZN8AppStateE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'get'
        QtMocHelpers::MethodData<QVariant(const QString &, const QVariant &) const>(6, 2, QMC::AccessPublic, 0x80000000 | 4, {{
            { QMetaType::QString, 3 }, { 0x80000000 | 4, 7 },
        }}),
        // Method 'get'
        QtMocHelpers::MethodData<QVariant(const QString &) const>(6, 2, QMC::AccessPublic | QMC::MethodCloned, 0x80000000 | 4, {{
            { QMetaType::QString, 3 },
        }}),
        // Method 'set'
        QtMocHelpers::MethodData<void(const QString &, const QVariant &)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { 0x80000000 | 4, 5 },
        }}),
        // Method 'remove'
...
void AppState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { QVariant _r = _t->get((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QVariant>>(_a[2])));
            if (_a[0]) *reinterpret_cast< QVariant*>(_a[0]) = std::move(_r); }  break;
        case 2: { QVariant _r = _t->get((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariant*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->set((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QVariant>>(_a[2]))); break;
        case 4: _t->remove((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AppState::*)(QString , QVariant )>(_a, &AppState::valueChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void AppState::valueChanged(QString _t1, QVariant _t2)
{
